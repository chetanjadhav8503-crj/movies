...
API_ID = int(environ.get('API_ID', '32800910'))
API_HASH = environ.get('API_HASH', '0cff9e94b5edf5ecd6dca783c21ae81b')
BOT_TOKEN = environ.get('BOT_TOKEN', '8806666027:AAFzStoEuciMAwQYTEXEy49F0J4iy9n8bWQ')
#---------------------------------------------------------BOT_TOKEN = environ.get('BOT_TOKEN', '7807I9ygow9sLqNQuI7hsWPm5FLNfBr9c')------
#---------------------------------------------------------------
ADMINS = [int(admin) if id_pattern.search(admin) else admin for admin in environ.get('ADMINS', '7996733504').split()]
USERNAME = environ.get('USERNAME', "https://t.me/Kingkong887666") # ADMIN USERNAME
LOG_CHANNEL = int(environ.get('LOG_CHANNEL', '-1004420638482'))
MOVIE_GROUP_LINK = environ.get('MOVIE_GROUP_LINK', 'https://t.me/All_Reality_Show_Episodes_Bot')
